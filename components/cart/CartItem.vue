    ...
    <div class="flex justify-between mt-[14px] mb-[14px] md:px-[29px]">
      ...
      <div class="flex flex-1 justify-end">
        ...
        <p class="flex-1 text-[#EBE4DF] text-[14px] font-normal leading-normal hidden md:block">
          <span v-if="item.discount_value" class="block line-through text-[12px]">
            <span class="sar-icon">&#xe900;</span> {{ item.total_price_before_discount_with_tax }}
          </span>
          <span class="block">
            <span class="sar-icon">&#xe900;</span> {{ item.total_price_with_tax }}
          </span>
          <!-- <span class="block">
