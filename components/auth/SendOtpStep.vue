<template>
  <div class="max-w-[473px] mx-auto py-[100px]">
    ...
    <div class="flex rounded-[14.37px] border-[1.2px] px-[18px] py-[15px] text-[16.76px] font-normal leading-[31.28px] tracking-[2.61px] text-[#A0576F] mobile_number">
    ...
    <div class="flex items-center gap-[10px] mt-[20px]">
      <label class="relative flex items-center cursor-pointer select-none">
        ...
        <div class="w-[20px] h-[20px] rounded-full border-2 border-[#A0576F] flex items-center justify-center peer-checked:bg-[#A0576F] transition">
          <div class="w-[10px] h-[10px] rounded-full bg-[#EBE4DF] scale-0 peer-checked:scale-100 transition-transform duration-200"></div>
        </div>
      </label>
...
const openTerms = () => {
  legalUrl.value = 'https://lasuran.com/terms'
  showLegalModal.value = true
}

const openPrivacy = () => {
  legalUrl.value = 'https://lasuran.com/privacy'
  showLegalModal.value = true
}
</script>
